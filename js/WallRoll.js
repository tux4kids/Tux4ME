    ...
    function preload() {
        game.load.image('bg', 'assets/images/WallRoll/bg.png');
        game.load.image('hgl', 'assets/images/WallRoll/hgl.png');
        game.load.image('vgl', 'assets/images/WallRoll/vgl.png');
        game.load.image('dead', 'assets/images/WallRoll/dead.png');
        game.load.image('living', 'assets/images/WallRoll/living.png');
        game.load.image('1', 'assets/images/WallRoll/1.png');
        game.load.image('2', 'assets/images/WallRoll/2.png');
        game.load.image('3', 'assets/images/WallRoll/3.png');
        game.load.image('4', 'assets/images/WallRoll/4.png');
        game.load.image('5', 'assets/images/WallRoll/5.png');
        game.load.image('6', 'assets/images/WallRoll/6.png');
